...
private products: Product[] = [
  {
    ...
    category: "running",
    images: [
      "assets/premium-white-running-shoe-with-orange-accents.jpg",
      "assets/premium-white-running-shoe-side-view.jpg",
      "assets/premium-white-running-shoe-back-view.jpg",
      "assets/premium-white-running-shoe-sole-detail.jpg",
    ],
  ...
  },
  {
    ...
    category: "running",
    images: [
      "assets/black-running-shoe-with-white-boost-sole.jpg",
      "assets/black-running-shoe-side-profile.jpg",
      "assets/black-running-shoe-top-view.jpg",
      "assets/black-running-shoe-boost-technology.jpg",
    ],
    sizes: ["38", "39", "40", "41", "42", "43", "44", "45"],
  ...
  },
  {
    ...
    category: "running",
    images: [
      "assets/neon-green-running-shoe-lightweight.jpg",
      "assets/neon-green-running-shoe-side-view.jpg",
      "assets/neon-green-running-shoe-flex-technology.jpg",
